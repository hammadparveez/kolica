...
Widget getFeedBackListView() {
  return Container(
    ...
    child: ListView(
      ...
      children: [
        ListTile(
          contentPadding: const EdgeInsets.only(left: kDefaultPadding,top: 10,right: kDefaultPadding,bottom: 5),
          title: Text(
            "Satisfied",
            style:
        ...
        ListTile(
          contentPadding: const EdgeInsets.only(left: kDefaultPadding,top: 5,right: kDefaultPadding,bottom: 5),
          title: Text(
            "Average",
            style:
            TextStyle(fontSize: kDefaultFontSizeTitle, color: kTextColor),
