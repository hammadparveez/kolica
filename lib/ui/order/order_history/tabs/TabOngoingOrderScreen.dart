...
class TabOngoingOrderScreen extends StatefulWidget {
  @override
  _TabOngoingOrderScreenState createState() => _TabOngoingOrderScreenState();
}

class _TabOngoingOrderScreenState extends State<TabOngoingOrderScreen> {
  @override
          ...
          Positioned.fill(
            child: ListView(
              ...
              children: [
                ...
                cartItemsWidget(context, incrementCounter, counter, decrementCounter),
                SizedBox(height: 15),
                cartTextWidget(context),
                cartItemsWidget2(context, incrementCounter, counter, decrementCounter),
                SizedBox(height: 15),
              ],
            ),
          ),
  ...
  Container cartItemsWidget(BuildContext context, void incrementCounter(), int counter, void decrementCounter()) {
    return Container(
                                    ...
                                    children: [
                                      Flexible(
                                        child: Text(
                                          'Sub Total: \$360',
                                          overflow: TextOverflow.ellipsis,
                                          style: Theme.of(context).textTheme.subtitle1.copyWith(fontSize: 14,height: 1),
                                        ),
                                      ),
                                    ],
                                  ),
  ...
  Container cartItemsWidget2(BuildContext context, void incrementCounter(), int counter, void decrementCounter()) {
    return Container(
      padding: const EdgeInsets.all(kDefaultPadding),
      decoration: BoxDecoration(
        color: Colors.white,
