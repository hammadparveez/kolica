              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.only(topLeft:Radius.circular(Dimension.Size_5),topRight:Radius.circular(Dimension.Size_5),),
                    //boxShadow: Themes.defaultShadow,
                  ),
                  child: Padding(
                    padding: const EdgeInsets.only(left: kDefaultPadding2,top: kDefaultPadding2,right: kDefaultPadding2,bottom: 0),
                    child: Center(
                      child: Image.asset(
