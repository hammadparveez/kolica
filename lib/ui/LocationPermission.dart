...
import 'package:kolica/Providers/LocationPermissionProvider.dart';
import 'package:kolica/Providers/SplashProvider.dart';
...
class _LocationPermissionState extends State<LocationPermission> with TickerProviderStateMixin {
        ...
        children: [
          Container(
            child: Column(
              ...
              children: [
                SvgPicture.asset('assets/images/location-permission.svg',height: Get.height*0.2,),
                Padding(
                  padding: EdgeInsets.all(Dimension.Size_30),
                  child: Text(language.Location_Permission_Message,style: Theme.of(context).textTheme.bodyText1,textAlign: TextAlign.center,),
                )
              ],
            ),
          ),
          Positioned(
            ...
            child : LoadingButton(
              ...
              child: Container(
                  ...
                  child: Text(language.Continue,style: Theme.of(context).textTheme.bodyText1.copyWith(color: Themes.White,fontSize: Dimension.Size_20),)
              ),
            ),
          )
        ],
