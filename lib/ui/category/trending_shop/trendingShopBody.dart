...
class TrendingShopBody extends StatefulWidget {
  @override
  _TrendingShopBodyState createState() => _TrendingShopBodyState();
}

class _TrendingShopBodyState extends State<TrendingShopBody> {
