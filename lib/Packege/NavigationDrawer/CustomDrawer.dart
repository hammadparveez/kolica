...
class _CustomDrawerState extends State<CustomDrawer> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    super.initState();
    navigationController=AnimationController(vsync: this, duration: Duration(milliseconds: 450));
  }
              ...
              child: AnimatedContainer(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(isOpen ? Dimension.Size_30 : 0)),
                      child: Stack(
                        children: [
  ...
  void changeLayout(){
    ...
    secondLayerState.setState(() {
      secondLayerState.xoffSet =isOpen ? 0 :
      Get.width * 0.6;
      secondLayerState.yoffSet =isOpen ? 0 :
      Get.height * 0.15;
      secondLayerState.angle = isOpen ? 0 : -0.15;
    });
    thirdLayerState.setState(() {
      thirdLayerState.xoffSet =isOpen ? 0 :
      Get.width * 0.625;
      thirdLayerState.yoffSet =isOpen ? 0 :
      Get.height * 0.125;
