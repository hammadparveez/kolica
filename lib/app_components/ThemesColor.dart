...
class Themes{
  static Color Primary=Color(0xFF4B36EA);
  static Color Primary2=Color(0xFFFFA647);
  static Color Primary3=Color(0xFFEEF1F7);
...
// notification page
  ...
  static randomColor()=>Colors.primaries[Random().nextInt(Colors.primaries.length)];
}
...
import 'package:kolica/Dimension/Dimension.dart';
