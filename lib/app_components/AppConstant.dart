import 'package:kolica/Language/EN.dart';

class AppConstant {
  static String AppName = 'Kolica';
  ...
  static String Default_Country = 'bd';
  static String Default_Language = 'en';
  static String Default_Phone_Code = '+88';
 ...
 // static AppLocale Default_Locale = AppLocale.EN;
  ...
  List<String> OnboardingTitle=['Fusce luctus luctus auctor.','Duis dapibus nisl vitae.','Augue vulputate tempu.'];
  List<String> OnboardingMessage=['Lorem ipsum dolor sit amet, consectetur adipiscing aenean ac tortor faucibus, gravida massa sit amet, vestibulum odio. Cras tortor risus, vestibulum at posuere Lorem ipsum dolor sit amet, consectetur adipiscing elit.','Lorem ipsum dolor sit amet, consectetur adipiscing aenean ac tortor faucibus, gravida massa sit amet, vestibulum odio. Cras tortor risus, vestibulum at posuere Lorem ipsum dolor sit amet, consectetur adipiscing elit.','ALorem ipsum dolor sit amet, consectetur adipiscing aenean ac tortor faucibus, gravida massa sit amet, vestibulum odio. Cras tortor risus, vestibulum at posuere Lorem ipsum dolor sit amet, consectetur adipiscing elit.'];
  ...
  String Location_Permission_Message='For the best experience,please grant us permission to use your location.';
  ...
  String Enter_Phone_number_message='Lorem ipsum dolor sit amet, consectetur adipiscing aenean ac tortor faucibus gravida.';
  ...
  List<String> Forgot_Password_Title=['Forget Password','Code Verification','Reset Password'];
  List<String> Forgot_Password_Message=['Enter your email address, I will send you a code for resetting your password.','We sent a verification code in your email address. please check - mariahernandez@gmail.com','Enter your email address, I will send you a code for resetting your password.'];
...
*/
  ...
  List<String> Main_Page_Tab=['Home','Category','Favorite','Search','Message'];
